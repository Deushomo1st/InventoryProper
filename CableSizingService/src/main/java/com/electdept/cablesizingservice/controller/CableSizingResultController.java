...
import com.electdept.cablesizingservice.service.CableSizingResultService;
...
@RestController
@RequestMapping("/cablesizing/results")
public class CableSizingResultController {

    private final CableSizingResultService service;

    public CableSizingResultController(CableSizingResultService service) {
